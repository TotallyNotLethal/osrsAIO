...
public class FishingRequirements {
    ...
    static {
        ...
        fishToEquipmentMap.put(FishType.SARDINE, new FishingEquipment[]{FishingEquipment.FISHING_ROD, FishingEquipment.FISHING_BAIT});
        fishToEquipmentMap.put(FishType.HERRING, new FishingEquipment[]{FishingEquipment.FISHING_ROD, FishingEquipment.FISHING_BAIT});
        fishToEquipmentMap.put(FishType.PIKE, new FishingEquipment[]{FishingEquipment.FISHING_ROD, FishingEquipment.FISHING_BAIT});
        fishToEquipmentMap.put(FishType.SLIMY_EEL, new FishingEquipment[]{FishingEquipment.FISHING_ROD, FishingEquipment.FISHING_BAIT});
        fishToEquipmentMap.put(FishType.CAVE_EEL, new FishingEquipment[]{FishingEquipment.FISHING_ROD, FishingEquipment.FISHING_BAIT});
        fishToEquipmentMap.put(FishType.SACRED_EEL, new FishingEquipment[]{FishingEquipment.FISHING_ROD, FishingEquipment.FISHING_BAIT});
        fishToEquipmentMap.put(FishType.ANGLERFISH, new FishingEquipment[]{FishingEquipment.FISHING_ROD, FishingEquipment.SANDWORMS});
        fishToEquipmentMap.put(FishType.TROUT, new FishingEquipment[]{FishingEquipment.FLY_FISHING_ROD, FishingEquipment.FEATHER});
        fishToEquipmentMap.put(FishType.SALMON, new FishingEquipment[]{FishingEquipment.FLY_FISHING_ROD, FishingEquipment.FEATHER});
        fishToEquipmentMap.put(FishType.RAINBOW_FISH, new FishingEquipment[]{FishingEquipment.FLY_FISHING_ROD, FishingEquipment.STRIPY_FEATHER});
        fishToEquipmentMap.put(FishType.LEAPING_TROUT, new FishingEquipment[]{FishingEquipment.BARBARIAN_ROD, FishingEquipment.FISHING_BAIT});
        fishToEquipmentMap.put(FishType.LEAPING_SALMON, new FishingEquipment[]{FishingEquipment.BARBARIAN_ROD, FishingEquipment.FISHING_BAIT});
        fishToEquipmentMap.put(FishType.LEAPING_STURGEON, new FishingEquipment[]{FishingEquipment.BARBARIAN_ROD, FishingEquipment.FISHING_BAIT});
        fishToEquipmentMap.put(FishType.LAVA_EEL, new FishingEquipment[]{FishingEquipment.OILY_FISHING_ROD, FishingEquipment.FISHING_BAIT});
        fishToEquipmentMap.put(FishType.INFERNAL_EEL, new FishingEquipment[]{FishingEquipment.OILY_FISHING_ROD, FishingEquipment.FISHING_BAIT});
        fishToEquipmentMap.put(FishType.LOBSTER, new FishingEquipment[]{FishingEquipment.LOBSTER_POT});
        fishToEquipmentMap.put(FishType.DARK_CRAB, new FishingEquipment[]{FishingEquipment.LOBSTER_POT, FishingEquipment.DARK_FISHING_BAIT});
        fishToEquipmentMap.put(FishType.KARAMBWAN, new FishingEquipment[]{FishingEquipment.KARAMBWAN_VESSEL, FishingEquipment.RAW_KARAMBWANJI});
