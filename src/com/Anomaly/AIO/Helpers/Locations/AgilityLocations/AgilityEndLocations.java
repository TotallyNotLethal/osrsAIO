...
public class AgilityEndLocations {
    ...
    static {
        ...
        allEndLocationsSpots.put(Location.ARDOUGNE, new Spot(new Area(2672, 3298, 2675, 3296), true));
        ...
        allEndLocationsSpots.put(Location.WILDERNESS, new Spot(new Area(2997, 3915, 2999, 3914), true));
